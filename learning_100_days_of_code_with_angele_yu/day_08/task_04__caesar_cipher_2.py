...
# This is an illogical way to combine the encrypt() and decrypt() functions in this example. 👇❌
# It will produce output as long as both functions above are active.
#
# def caesar(encrypt_or_decrypt):
...
# The best practice for combining the encrypt() and decrypt() functions 👇✅
