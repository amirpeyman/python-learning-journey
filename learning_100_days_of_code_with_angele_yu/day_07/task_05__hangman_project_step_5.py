...
from hangman_art import stages, logo        # or import hangman_art ✅

lives = 6

# 3: - Import the logo from hangman_art.py and print it at the start of the game.
print(logo)         # or "print(hangman_art.logo)" if in line 6 typed "import hangman_art" ✅

chosen_word = random.choice(word_list)          # or "chosen_word = random.choice(hangman_words.word_list)" if in line 5
                                                # typed "import hangman_words" ✅
print(chosen_word)
...
while not game_over:
    ...
    print(stages[lives])        # or "print(hangman_art.stages[lives])" if in line 6 typed "import hangman_art" ✅
